...
class Model {
    ...
    init() {
        ...
        model.addQuestion(question: Question(capital: "La Havane", pays: "Cuba", continent: .europe))
        ...
        model.addQuestion(question: Question(capital: "Sénégal", pays: "Dakar", continent: .afrique))
        ...
        model.addQuestion(question: Question(capital: "Bzngkok", pays: "Thaïlande", continent: .asieOcéanie))
